              ...
              children: [
                ...
                Expanded(
                  child: AnimatedCrossFade(
                    ...
                    firstChild: const Spacer(),
                    secondChild: Text(title, style: Theme.of(context).textTheme.titleMedium, maxLines: 1, overflow: TextOverflow.ellipsis,),
                  ),
                ),
                // const Spacer(),
                AnimatedSwitcher(
                  duration: animationDuration,
                  child: showCategoryDate ? IconButton(onPressed: () {_showBottomSheet(context);}, icon: Image.asset('assets/icons/ic_more.png', height: 24, width: 24,),) : const SizedBox.shrink(),
                ),
              ],
            ),
          ),
